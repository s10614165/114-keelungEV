...
const sections = {
    basic: document.querySelector('section:has(#file-affidavit)'),
    green: document.querySelector('section:has(#file-green-train)'),
    retain: document.querySelector('section:has(#file-retain-train)'),
    equip: document.querySelector('section:has(#file-equip-invoice)')
};
